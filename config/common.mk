...
PRODUCT_COPY_FILES += \
    ...
    vendor/lineage/config/permissions/privapp-permissions-crdroid-product.xml:$(TARGET_COPY_OUT_PRODUCT)/etc/permissions/privapp-permissions-crdroid.xml \
    vendor/lineage/config/permissions/privapp-permissions-crdroid-system.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/permissions/privapp-permissions-crdroid.xml \
